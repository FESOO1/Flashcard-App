        ...
        <div class="flashcard-itself">
            <div class="flashcard-itself-inner">
                <div class="flashcard-itself-inner-question">
                    ...
                    <p class="flash-card-itself-inner-question-itself">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Harum laudantium nemo temporibus eligendi incidunt beatae repellendus autem deleniti doloremque quisquam quo error, explicabo vel culpa distinctio illum? Sint, iure consequatur.</p>
                </div>
                <div class="flashcard-itself-inner-answer">
                    <h4 class="flashcard-itself-inner-answer-text">Answer:</h4>
                    <p class="flash-card-itself-inner-answer-itself">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Harum laudantium nemo temporibus eligendi incidunt beatae repellendus autem deleniti doloremque quisquam quo error, explicabo vel culpa distinctio illum? Sint, iure consequatur.</p>
                </div>
            </div>
        </div>
    `;
